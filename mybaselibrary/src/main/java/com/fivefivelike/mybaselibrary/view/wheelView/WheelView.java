...
package com.fivefivelike.mybaselibrary.view.wheelView;
...
public class WheelView extends View {
	...
	/** 项目文本颜色 */
	private static final int ITEMS_TEXT_COLOR = Color.parseColor("#dadada");
...
//		centerDrawable.draw(canvas);
		...
		paint.setColor(getResources().getColor(R.color.basic_wheelview_color));
		// 设置线宽
